---
title: "Geospatial Analysis of Food Restaurants in New Delhi"
author: "Koki Ando"
date: "4/7/2018"
...
## India's geospatial data analysis
...
ggplot(nd.zomato) + geom_histogram(aes(Aggregate.rating)) + 
  ...
  geom_text(aes(x=mean.nd.restaurants, 
                label=paste("Mean",":", round(mean.nd.restaurants,3)), y = 200), colour="red",vjust = 3, text=element_text(size=11), family = "Times New Roman")
```
